...
Interaction-wit principle:

> **Clarity in the message. Wit in the interaction.**

Use self-aware interface behaviour selectively, where the interaction itself demonstrates the problem. Important information must remain understandable without triggering the interaction.
